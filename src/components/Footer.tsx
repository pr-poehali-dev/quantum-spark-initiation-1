...
const translations = {
  en: {
    ...
    followMe: "Follow",
    subtitle: "Body Therapist & Psychologist",
  ...
  de: {
    ...
    subtitle: "Körpertherapeutin & Psychologin",
  ...
  ru: {
    ...
    followMe: "Соцсети",
    subtitle: "Телесный терапевт · Психолог",
    ...
    <footer className="bg-charcoal text-warm-white py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-warm-white mb-4">Митаева Анастасия</h3>
        ...
        <div className="border-t border-warm-white/20 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-warm-white/70">
          <small>&copy; 2026 Митаева Анастасия. {t.copyright}</small>
